...
#--- 解码任务名称
decode_job_name=xdzj_$1
#--- 解码工作目录
decode_output_dir=$2
#--- 解码器conf
decode_conf=/mnt/QA_disk2/am_train_data/xiaoduzaijia/dynamic-wfst.home/conf
#--- 解码器data
data_dir=/mnt/QA_disk2/am_train_data/xiaoduzaijia/dynamic-wfst.home/data_xdzj.20190412
#--- 解码器lm
...
#--- 模型列表文件
model_file=/mnt/QA_disk2/am_train_data/xiaoduzaijia/dynamic-wfst.home/duhome_am2.17e2_20190131141703_20190131141703_CPU.mdl
#--- 解码bin
bin=/mnt/QA_disk2/am_train_data/xiaoduzaijia/dynamic-wfst.home/bin/dynamic_wfst_Stastic
#--- wer工具
